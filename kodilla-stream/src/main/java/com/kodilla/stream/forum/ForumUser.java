...
public final class ForumUser {
    ...
    public Set<String> getLocationsOfFriends() {
        return friends.stream().map(ForumUser::getLocation).collect(Collectors.toSet());              //ref do metody
        // return friends.stream().map(forumUser -> forumUser.getLocation()).collect(Collectors.toSet());  // lambda
