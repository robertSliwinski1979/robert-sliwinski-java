...
public class ReaderConfig {
    ...
    @Bean(name = "book1")   //W tym przykładzie obiekt zwracany przez metodę getBookOne() otrzymał nazwę book1
    @Scope("prototype")
    public Book getBookOne() {
        return new Book("The book number one");
    }

    @Bean(name = "book2")   //obiekt zwracany przez metodę getBookTwo() otrzymał nazwę book2.
    @Scope("prototype")
